...
class RestrictedBField final : public MagneticFieldProvider {
 public:
  ...
  RestrictedBField( const Vector3& field)
      ...
      std::shared_ptr<TrackingVolume> m_magVolume = TrackingVolume::create(Transform3(Translation3{0., 0., 32000.}),std::make_shared<const CuboidVolumeBounds>(1000., 3000., 4000.));
